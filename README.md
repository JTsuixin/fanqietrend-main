...
> 📚 覆盖**番茄小说男频 + 女频新书榜**，每日自动追踪排行数据并结合 AI 生成趋势分析，部署为精美的在线看板。
...
| 功能 | 说明 |
|------|------|
| 🕷️ 自动爬取 | 每日定时抓取番茄男频、女频频道各个分类的新书榜 Top 30 |
...
├── data/
│   ├── fanqie_ranks_YYYYMMDD.json  # 每日原始快照（男频+女频，历史快照为 fanqie_female_new_ranks_*）
